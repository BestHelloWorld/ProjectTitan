...
namespace cm
{
	...
	public:
		...
		void operator*=(const mat3 & m)
		{
			...
			v[1] = v[0] * m[1] + v[1] * m[4] + v[2] * m[7];
			v[2] = v[0] * m[2] + v[1] * m[5] + v[2] * m[8];
			v[3] = v[3] * m[0] + v[4] * m[3] + v[5] * m[6];
			v[4] = v[3] * m[1] + v[4] * m[4] + v[5] * m[7];
			v[5] = v[3] * m[2] + v[4] * m[5] + v[5] * m[8];
	...
	public:
		...
		void operator*=(const mat4 & m)
		{
			...
			v[1] = v[0] * m[1] + v[1] * m[5] + v[2] * m[9] + v[3] * m[13];
			v[2] = v[0] * m[2] + v[1] * m[6] + v[2] * m[10] + v[3] * m[14];
			v[3] = v[0] * m[3] + v[1] * m[7] + v[2] * m[11] + v[3] * m[15];
			v[4] = v[4] * m[0] + v[5] * m[4] + v[6] * m[8] + v[7] * m[12];
			v[5] = v[4] * m[1] + v[5] * m[5] + v[6] * m[9] + v[7] * m[13];
			v[6] = v[4] * m[2] + v[5] * m[6] + v[6] * m[10] + v[7] * m[14];
			v[7] = v[4] * m[3] + v[5] * m[7] + v[6] * m[11] + v[7] * m[15];
			v[8] = v[8] * m[0] + v[9] * m[4] + v[10] * m[8] + v[11] * m[12];
			v[9] = v[8] * m[1] + v[9] * m[5] + v[10] * m[9] + v[11] * m[13];
			v[10] = v[8] * m[2] + v[9] * m[6] + v[10] * m[10] + v[11] * m[14];
			v[11] = v[8] * m[3] + v[9] * m[7] + v[10] * m[11] + v[11] * m[15];
			v[12] = v[12] * m[0] + v[13] * m[4] + v[14] * m[8] + v[15] * m[12];
	...
	namespace
	{
		...
		*/
		...
		vec3 vec3_cast(const vec2 & v, FLOAT z = 0.0f)
		{
			vec3 r;
			r.x = v.x;
			r.y = v.y;
		...
		vec4 vec4_cast(const vec2 & v, FLOAT z = 0.0f, FLOAT w = 1.0f)
		{
			vec4 r;
			r.x = v.x;
			r.y = v.y;
		...
		vec4 vec4_cast(const vec3 & v, FLOAT w = 1.0f)
		{
			vec4 r;
			r.x = v.x;
			r.y = v.y;
		...
		FLOAT rayPicking(vec3 ray_vector, vec3 camera_pos, vec3 model_pos)
		{
			FLOAT len = (camera_pos - model_pos).magnitude();
			vec3 new_ray = camera_pos + ray_vector * len;
			return (new_ray - model_pos).magnitude();
		}
	}
}
