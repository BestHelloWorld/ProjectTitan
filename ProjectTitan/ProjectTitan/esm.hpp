...
namespace esm
{
	...
	public:
		...
		{
			v[0] = r1.x; v[1] = r1.y; v[2] = r1.z;
			v[3] = r2.x; v[4] = r2.y; v[5] = r2.z;
			v[6] = r3.x; v[7] = r3.y; v[8] = r3.z;
		}
	...
	public:
		...
		mat4(const mat3 & m)
		{
			v[0] = m[0]; v[1] = m[1]; v[2] = m[2]; v[3] = 0.0f;
			v[4] = m[3]; v[5] = m[4]; v[6] = m[5]; v[7] = 0.0f;
			v[8] = m[6]; v[9] = m[7]; v[10] = m[8]; v[11] = 0.0f;
		...
		{
			mat4 r(*this);
			r.v[0] += m[0]; r.v[1] += m[1]; r.v[2] += m[2]; r.v[3] += m[3];
			r.v[4] += m[4]; r.v[5] += m[5]; r.v[6] += m[6]; r.v[7] += m[7];
			r.v[8] += m[8]; r.v[9] += m[9]; r.v[10] += m[10]; r.v[11] += m[11];
			r.v[12] += m[12]; r.v[13] += m[13]; r.v[14] += m[14]; r.v[15] += m[15];
			return r;
		}
		mat4 operator-(const mat4 & m)
		{
	...
	namespace
	{
		...
		mat4 rotate(FLOAT deg, FLOAT x, FLOAT y, FLOAT z)
		{
			...
			r.v[0] = x * x + (1 - x * x)*C, r.v[1] = x * y*(1 - C) + z * S, r.v[2] = x * z*(1 - C) - y * S, r.v[3] = 0.0f;
			r.v[4] = x * y*(1 - C) - z * S, r.v[5] = y * y + (1 - y * y)*C, r.v[6] = y * z*(1 - C) + x * S, r.v[7] = 0.0f;
			r.v[8] = x * z*(1 - C) + y * S, r.v[9] = y * z*(1 - C) - x * S, r.v[10] = z * z + (1 - z * z)*C, r.v[11] = 0.0f;
			r.v[12] = 0.0f, r.v[13] = 0.0f, r.v[14] = 0.0f, r.v[15] = 1.0f;
		...
		mat4 lookAt(FLOAT eyex, FLOAT eyey, FLOAT eyez, FLOAT centerx, FLOAT centery, FLOAT centerz, FLOAT upx, FLOAT upy, FLOAT upz)
		{
			...
			mat4 R;
			R.v[0] = x.x, R.v[1] = x.y, R.v[2] = x.z, R.v[3] = 0.0f;
			R.v[4] = y.x, R.v[5] = y.y, R.v[6] = y.z, R.v[7] = 0.0f;
			R.v[8] = z.x, R.v[9] = z.y, R.v[10] = z.z, R.v[11] = 0.0f;
			R.v[12] = 0.0f, R.v[13] = 0.0f, R.v[14] = 0.0f, R.v[15] = 1.0f;
			mat4 T;
			T.v[0] = 1.0f, T.v[1] = 0.0f, T.v[2] = 0.0f, T.v[3] = -eyex;
			T.v[4] = 0.0f, T.v[5] = 1.0f, T.v[6] = 0.0f, T.v[7] = -eyey;
			T.v[8] = 0.0f, T.v[9] = 0.0f, T.v[10] = 1.0f, T.v[11] = -eyez;
			T.v[12] = 0.0f, T.v[13] = 0.0f, T.v[14] = 0.0f, T.v[15] = 1.0f;
