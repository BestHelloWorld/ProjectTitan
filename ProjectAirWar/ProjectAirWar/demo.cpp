...
void _stdcall ModelProc(Model * model)
{
	if (model->mIsHide)
		return;
...
void MainScene::SetViewport(FLOAT width, FLOAT height)
{
	...
	sm.Init("res/shader/v.vs", "res/shader/f.fs", width, height, "res/font/msyh.ttc");
	sm.New("res/images/earth.bmp", L"BTN 1", 0.0f, 0.0f, 100.0f, 100.0f);
	sm.New("res/images/earth.bmp", L"BTN 2", 100.0f, 200.0f, 100.0f, 100.0f);
